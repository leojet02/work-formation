...
var plane = document.getElementById("plane"),
    ...
    width = plane.width = window.innerWidth,
    height = plane.height = window.innerHeight,
    particles = [],
    mouseX = 0,
    mouseY = 0,
    total = 15,
...
window.addEventListener('resize', function () {
    width = plane.width = window.innerWidth - 10;
    height = plane.height = window.innerHeight - 10;
});
